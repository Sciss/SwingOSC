...
To compile and assemble SwingOSC, run `./sbt assembly`. The final fully self-contained jar file will be `target/SwingOSC-assembly-0.70-SNAPSHOT.jar`. Make sure you adjust your `SwingOSC.program` settings in SuperCollider accordingly.
