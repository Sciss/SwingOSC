...
public class URLUtil {
    /***************************************************************************************
     * The following are from org.apache.commons.httpclient.URI (version 3.1)
     */
    ...
    /***************************************************************************************
     * The following methods are taken from org.apache.commons.codec.net.URLCodec (version 1.6)
     */
    ...
    public static String encode( String unescaped, BitSet allowed, String charset ) throws MalformedURLException {
        try {
            ...
            throw new MalformedURLException( unescaped );
        }
    }
     ...
     *
     * @throws MalformedURLException if the charset is not supported
     *
     * @see #encode
     */
    public static String encodePathQuery(String unescaped, String charset) throws MalformedURLException {
